...
Please let me know of any suggestions / bugs, I think you can do this using the "Issues tab" on this github page (I'm new to using Github)<br>
...
Once you have downloaded the mod and put "imageBlock" in your mods folder, it should look like `/mods/imageBlock/imageBlock/...`.<br>
